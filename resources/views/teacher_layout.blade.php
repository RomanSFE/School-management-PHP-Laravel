...
<head>
  ...
  <title>Chapra Model School | Teacher Dashboard</title>
  <!-- plugins:css -->
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('/teacher_dashboard')}}"><img src="images/salt_logo.svg" alt="Logo"></a>
      </div>
